...
def generate_launch_description():
    ...
    declare_args = [
        ...
        DeclareLaunchArgument('config_file', default_value=os.path.join(tb3_fleet_share, 'maps', 'tb3_world', 'tb3_world.building.yaml')),
        DeclareLaunchArgument('initial_map', default_value='tb3_world'),
        ...
        DeclareLaunchArgument('viz_config_file', default_value=default_viz_config),
    ]
    ...
    # KHAC BIET DUY NHAT: dung free_fleet_adapter goc thay vi tb3_fleet.tb3_fleet_adapter
