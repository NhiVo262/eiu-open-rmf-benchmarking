...
def generate_launch_description():
    ...
    declare_use_rviz_cmd = DeclareLaunchArgument(
        ...
        description='Whether to start global RViz view (off by default to reduce CPU load when benchmarking N=5)')

    declare_use_gzclient_cmd = DeclareLaunchArgument(
        'use_gzclient', default_value='False',
        description='Whether to start Gazebo GUI client (off by default to reduce CPU load when benchmarking N=5)')
